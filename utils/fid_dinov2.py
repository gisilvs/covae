...
class FrechetInceptionDistanceDinoV2(Metric):
    ...
    Using the default feature extraction (Dino v2 using the original weights from `fid ref2`_), the input is
    ...
    Example:
        ...
        >>> fid = FrechetInceptionDistanceDinoV2(feature=1024)
    ...
    def set_dtype(self, dst_type: Union[str, torch.dtype]) -> "Metric":
        ...
        if isinstance(out.inception, NoTrainDinoV2):
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> metric = FrechetInceptionDistance(feature=1024)
            >>> values = [ ]
            >>> for _ in range(3):
            ...     metric.update(imgs_dist1(), real=True)
            ...     metric.update(imgs_dist2(), real=False)
